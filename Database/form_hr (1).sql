...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 05, 2022 at 05:50 AM
...
('12345678', 'แสงเดือน', 'เพ็ชรประดิษฐ', 'sang', 'phech', 'แมว', '111', '88', '26', '2022-04-04', 'ded@mail.com', '123456', 'IMGEMP_12345678.png', '16', 'รายเดือน', 207, '123', 'ทำงานอยู่', '', '2022-04-04', 'wait');
...
--
ALTER TABLE `hr_position`
  MODIFY `id_position` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=121;
...
--
ALTER TABLE `project_hr`
  MODIFY `hr_run_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=208;
COMMIT;
